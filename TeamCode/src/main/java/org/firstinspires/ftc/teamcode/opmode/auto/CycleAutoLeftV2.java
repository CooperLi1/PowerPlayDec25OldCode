...
@Autonomous
public class CycleAutoLeftV2 extends LinearOpMode {
...
//                .waitSeconds(1.5)
                ...
                .setReversed(true)
                // Preplaced
                .lineToLinearHeading(new Pose2d(-45, -10.5, Math.toRadians(240)))
                ...
                .waitSeconds(0.8)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-70, -12, Math.toRadians(195)))//345
                ...
                .waitSeconds(0.3)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-40, 2, Math.toRadians(197.5)))
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> {
                ...
                .waitSeconds(0.6)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-70, -10, Math.toRadians(197.5)))
                .setVelConstraint(robot.drive.getVelocityConstraint(35, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .forward(12)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                //pick up cone
                ...
                .waitSeconds(0.3)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-50, 2, Math.toRadians(200)))
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> {
                    robot.lift.setAutoRotation(-360);
                    robot.lift.setTargetHeight(36);
                    robot.lift.setArmPos(LiftConstants.IdleArm);
                ...
                .waitSeconds(0.6)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-70, -8, Math.toRadians(200)))
                .setVelConstraint(robot.drive.getVelocityConstraint(35, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .forward(12)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                //pick up cone
                ...
                .waitSeconds(0.3)
                .setVelConstraint(robot.drive.getVelocityConstraint(40, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-48, 2, Math.toRadians(202.5)))
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> {
                    robot.lift.setAutoRotation(-360);
                    robot.lift.setTargetHeight(36);
                    robot.lift.setArmPos(LiftConstants.IdleArm);
...
//                .waitSeconds(1.5)
                ...
                .setReversed(true)
                // Preplaced
                .lineToLinearHeading(new Pose2d(-45, -10.5, Math.toRadians(260)))
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> {
                    robot.lift.setTargetHeight(36);
                    robot.lift.setArmPos(LiftConstants.IdleArm);
                })
